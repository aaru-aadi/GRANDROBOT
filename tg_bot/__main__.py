...
TECHNO_IMG = "https://telegra.ph/file/7c9a69d055cabca529221.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Ashnor_love_delhi")],
                                                                                   [InlineKeyboardButton(text="₳ƉƉ ₦ɆɆ₮ ₳ƗƗⲘ$ & ɈɆɆ Ø₣₣Ɨ€Ɨ₳Ⱡ ɃØ₮ ₮Ø ¥ØɄɌ ₲ɌØɄ₱",
        ...
        update.effective_message.reply_text("Heya! I'am here because of🩺Dr.Ash🩺")
